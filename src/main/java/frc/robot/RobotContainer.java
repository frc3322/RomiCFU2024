...
public class RobotContainer implements Loggable{
  ...
  private final DriveToDistanceCommand m_autoCommand = new DriveToDistanceCommand(12, m_romiDrivetrain);
  ...
  private final Command driveCommand = new RunCommand(
    () -> {
      ...
      m_romiDrivetrain.arcadeDrive(speed, turn);
    },
    m_romiDrivetrain
  );
  ...
  private void configureButtonBindings() {
    ...
    driverController.a().onTrue(new DriveToDistanceCommand(12, m_romiDrivetrain).withTimeout(5));
  }
